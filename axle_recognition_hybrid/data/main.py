...
min_testing_samples = 0      # The minimum number of instances kept for testing in each class.
max_testing_samples = 0      # The maximum number of instances kept for testing in each class.
