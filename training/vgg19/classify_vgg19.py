...
dir_photos = f'{dir_braid}results/vgg19/photos/'
dir_photos_hit = f'{dir_braid}results/vgg19/photos/hit/'
dir_photos_miss = f'{dir_braid}results/vgg19/photos/miss/'
...
def main():
    print("Classifying all instances using the saved VGG19 model.")
    ...
    model = tf.keras.models.load_model(f'{dir_model}vgg19.keras')
    print(model.summary())
