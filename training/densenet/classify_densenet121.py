...
dir_model = f'{dir_braid}models/DenseNet121/'
dir_results = f'{dir_braid}results/DenseNet121/'
dir_photos = f'{dir_braid}results/DenseNet121/photos/'
dir_photos_hit = f'{dir_braid}results/DenseNet121/photos/hit/'
dir_photos_miss = f'{dir_braid}results/DenseNet121/photos/miss/'
...
def main():
    print("Classifying all instances using the saved DenseNet121 model.")
    ...
    model = tf.keras.models.load_model(f'{dir_model}densenet121.keras')
    print(model.summary())
